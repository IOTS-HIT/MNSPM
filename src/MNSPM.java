...
//            System.out.println("Processing sequence " + i);
    ...
    static void Mining_patterns(Sequence[] SDB, Pattern candidate, List<Pattern>[] frequent) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to the MNSPM!");
...
//             System.out.println(length+1 + "-Candidate Patterns: " + candidate.size());
            ...
            for (Pattern cand : candidate) {
                Mining_patterns(SDB, cand, frequent);
            }
            candidate.clear();
        }
