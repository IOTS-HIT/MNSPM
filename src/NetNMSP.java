...
public class NetNMSP {
    ...
    static class SeqDB {
        int id; // sequence id
        char[] S = new char[N]; // sequence
    }
    static class Occurrence { // occurrence
    ...
    // SeqDB[] sDB = new SeqDB[K];  // Sequence database
...
//            System.out.println("File opened successfully.");
    ...
    static void genCandidate(int level) {
        ...
        for (int i = 0; i < size; i++) {
            String Q = "", R = "";
            //R = freArr[level - 1].get(i).substring(1, level - 1);
...
//                    if (!nettree[j].get(child).used && ((a1 <= maxlen && a1 >= minlen) || (b1 >= minlen && b1 <= maxlen))) {
...
//        for(String pattern : maximalPatterns)
...
//        filepaths.add("result/gap/SDB1/NOSEP.txt");
//        filepaths.add("result/gap/SDB2/NOSEP.txt");
//        filepaths.add("result/minsup/SDB1/NOSEP.txt");
//        filepaths.add("result/minsup/SDB2/NOSEP.txt");
...
//            writer.write("The number of frequent patterns: " + frenum + "\n");
//            writer.write("Time used: " + df.format((endtime - begintime) / 1000.0) + "s" + "\n");
//            writer.write("Memory used: " + df.format(maxMemory) + "MB" + "\n");
//        } catch (IOException e) {
